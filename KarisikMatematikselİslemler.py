...
class Matematik():
    ...
    def giris(self):
        while True:
            ...
            print(
                "\nUYGULAMALAR{}{}{}{}{}{}{}\nÇıkış için buradaki sıra numaralarının dışında bir karakter girin.".format(
                    *self.__baslik.values()))
    ...
    def KombinasyonBulma(self, ne=0, re=0, Kendisi=True):
        if Kendisi:
            try:
                ...
                print("C({},{}) = {}".format(ne, re, self.FaktoriyelBulma(ne) / (
                            self.FaktoriyelBulma((ne - re)) * self.FaktoriyelBulma(re))))
